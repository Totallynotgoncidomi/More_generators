...
public class MoreGeneratorsModBlockEntities {
	...
	public static final RegistryObject<BlockEntityType<?>> ENERGYCAPACITY_CUCC = register("energycapacity_cucc", MoreGeneratorsModBlocks.ENERGYCAPACITY_CUCC, EnergycapacityCuccBlockEntity::new);
