...
import net.mcreator.moregenerators.fluid.OilFluid;
import net.mcreator.moregenerators.MoreGeneratorsMod;

public class MoreGeneratorsModFluids {
	public static final DeferredRegister<Fluid> REGISTRY = DeferredRegister.create(ForgeRegistries.FLUIDS, MoreGeneratorsMod.MODID);
