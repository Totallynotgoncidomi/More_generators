 ...
 *
 */
package net.mcreator.moregenerators;
...
public class MoreGeneratorsMod {
	public static final Logger LOGGER = LogManager.getLogger(MoreGeneratorsMod.class);
	public static final String MODID = "more_generators";

	public MoreGeneratorsMod() {
